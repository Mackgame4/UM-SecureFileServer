...
def encrypt(content, password):
    """ Encrypts the content using AES-GCM with a password-derived key. """
    salt = os.urandom(16)  # Generate a random salt
    nonce = os.urandom(12)  # Generate a nonce (12 bytes for AES-GCM)
...
def error():
    ...
    print("Usage:\n\tpython3 pbenc_aes_gcm.py enc <file>\n\tpython3 pbenc_aes_gcm.py dec <file>")
    sys.exit(1)
